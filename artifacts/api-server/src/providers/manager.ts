...
const snapshots = new Map<string, ProviderSnapshot>([
  ...
  [
    "dextools",
    {
      ...
      chains: [],
      description:
        "Official DEXTools V2 rankings with token-detail enrichment. Requires a DEXTools API key.",
      lastEventAt: null,
  ...
  [
    "pumpfun",
    {
      ...
      chains: ["SOLANA"],
      description:
        "Experimental no-key watcher using public Solana RPC and the official Pump.fun program definition. Not an official Pump.fun discovery API.",
      lastEventAt: null,
      error: "Experimental watcher is starting",
      eventsSeen: 0,
    },
  ],
  [
